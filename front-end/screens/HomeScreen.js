...
export default class HomeScreen extends Component {
  ...
  //   return (
  //     <View style={styles.checkStyle} onPress={this.onCheck}>
  //       <Text style={textCheck}>PHỔ BIẾN</Text>
  //     </View>
      // <CheckBox
  ...
  //   const textCheck = { color: color, fontSize: 20 };
  //   return (
  //     <View style={styles.checkStyle} onPress={this.onCheck}>
  //       <Text style={textCheck}>QUANH ĐÂY</Text>
  //     </View>
  //     // <CheckBox
  //     //   containerStyle={styles.checkStyle}
  //     //   textStyle={textCheck}
